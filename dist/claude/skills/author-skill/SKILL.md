...
3. Delegate the complete authoring job to /skill-creator:skill-creator. Do not copy or reinterpret its authoring contract.
4. Install only in the active provider: `.claude/skills/<name>/` for project scope or `~/.claude/skills/<name>/` for personal scope.
...
6. If /skill-creator:skill-creator is unavailable, stop with the exact missing capability. Do not hand-roll a replacement.
