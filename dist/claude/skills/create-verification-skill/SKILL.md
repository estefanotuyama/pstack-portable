...
Invoke /pstack:author-skill with project scope and pass it the complete grounded structure below. The authoring skill owns native structure and validation; this workflow owns the repo interview, feature map, and live proof. Do not bypass the authoring skill.
