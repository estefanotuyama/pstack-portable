...
- Existing-skill-first: propose `new skill via /pstack:author-skill:` only when no existing skill is a real home, the pattern recurs, and the topic deserves its own skill.
...
| <new pattern, no existing skill is a real home> | <draft a new skill via /pstack:author-skill> | <new skill via /pstack:author-skill: <kebab-name>> |
