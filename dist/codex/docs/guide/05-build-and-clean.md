...
The [Opening a PR playbook](../../skills/poteto-mode/playbooks/opening-a-pr.md) runs an inline code-cleanup pass on the diff before each commit and applies [`$pstack:unslop`](../../skills/unslop/SKILL.md) to the PR description and commit bodies. The inline pass means: remove narrating comments, unsupported guards, dead compatibility paths, and unrelated edits.
