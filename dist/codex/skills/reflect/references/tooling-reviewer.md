...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or provider-installed plugin locations)
- `native subagent capability` prompts that name a skill path
